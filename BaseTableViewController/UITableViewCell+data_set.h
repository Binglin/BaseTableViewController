...
#pragma mark - UITableViewCellDataDelegate
@protocol UITableViewCellDataDelegate <NSObject>
...
#pragma mark - UITableViewCellHeightDelegate
@protocol UITableViewCellHeightDelegate <NSObject>
@optional
//计算cell的高度
...
@interface UITableViewCell (data_set)<UITableViewCellHeightDelegate,UITableViewCellDataDelegate>
